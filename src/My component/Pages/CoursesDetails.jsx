...
const CoursesDetails = () => {
	...
	<div className="flex flex-col justify-between p-6 space-y-8">
		<div className="space-y-2">
			...
			<p className="dark:text-gray-100">{details.des}</p>
		</div>
		<button type="button" className="flex items-center justify-center w-full p-3 font-semibold tracking-wide rounded-md dark:bg-violet-400 dark:text-gray-900">CheckOut</button>
	</div>
</div>
